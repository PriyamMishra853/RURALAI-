      ...
      <div className="min-h-[60vh] flex items-center justify-center p-4">
        <div className="max-w-sm text-center space-y-3">
          ...
          <h2 className="text-base font-bold text-ink">
            {t('auth.roleDeniedTitle', 'Not available for your role')}
          </h2>
          <p className="text-xs text-ink-muted">
            {t('auth.roleDeniedBody', 'This area is restricted. Your account is signed in, but the role assigned to it does not include this section.')}
          </p>
          <a
