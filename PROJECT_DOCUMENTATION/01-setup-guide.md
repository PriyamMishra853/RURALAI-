...
npm run db:migrate 14_baseline_metrics.sql 15_case_referrals.sql 16_referral_tracking.sql 17_intake_provenance.sql 18_follow_ups.sql 19_intake_fields.sql 20_patient_uid.sql   # before switching on the optional features
